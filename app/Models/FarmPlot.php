...
class FarmPlot extends Model
{
    ...
    protected $fillable = [
        ...
        'is_agrarian_reform_beneficiary', 'ownership_type', 'ownership_type_other',
        'land_owner_first_name', 'land_owner_middle_name',
        'land_owner_surname', 'land_owner_ext_name', 'landowner_name', 'land_owner_rsbsa_no',
        'proof_of_ownership_document', 'proof_of_ownership_other',
        'commodity', 'planting_start_month', 'planting_end_month',
        'size_ha', 'no_of_heads_or_trees', 'farm_type', 'farm_type_other', 'is_organic',
        'cropping_schedule', 'rotational_tiller_full_name',
        'rotational_tiller_surname', 'rotational_tiller_first_name', 'rotational_tiller_middle_name',
        'remarks',
